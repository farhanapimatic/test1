...
public class BillingInfoController extends BaseController {    
    ...
    private static BillingInfoController instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the BillingInfoController class 
     */
    public static BillingInfoController getInstance() {
        synchronized (syncObject) {
            if (null == instance) {
                instance = new BillingInfoController();
            }
        }
        return instance;
    }
     ...
     * @param    accountId    Required parameter: The account id.
     ...
     */
    public void getBillinginfoByAccountIdAsync(
                final int accountId,
                final String alt,
                final String fields,
                final String key,
        ...
        _queryBuilder.append("/billinginfo/{accountId}");

        //process template parameters
        APIHelper.appendUrlWithTemplateParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5595853237160334911L;
            {
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4859294275287536863L;
            {
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4688751292241803981L;
            {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            BillingInfo _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<BillingInfo>(){});
     ...
     * @return    Returns the void response from the API call 
     */
    public void listBillinginfoAsync(
                final APICallBack<BillingInfoList> callBack
    ) {
        //the base uri for api requests
        String _baseUri = Configuration.baseUri;
        ...
        //prepare query string for API call
        StringBuilder _queryBuilder = new StringBuilder(_baseUri);
        _queryBuilder.append("/billinginfo");
        //validate and preprocess url
        String _queryUrl = APIHelper.cleanUrl(_queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5651242224080684286L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "Authorization", String.format("Bearer %1$s", Configuration.oAuthAccessToken) );
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            ...
                            //extract result from the http response
                            String _responseBody = ((HttpStringResponse)_response).getBody();
                            BillingInfoList _result = APIHelper.deserialize(_responseBody,
                                                        new TypeReference<BillingInfoList>(){});

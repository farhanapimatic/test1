...
### <a name="get_bibcode"></a>![Method: ](https://apidocs.io/img/method.png "BibcodeQuery.PCL.Controllers.APIController.GetBibcode") GetBibcode
...
Models.ReturnBibcode result = await client.GetBibcode(bibcode, dbKey, dataType);

...
```Python
from marvelcomics.marvelcomics_client import MarvelcomicsClient
```

![Add a new project in PyCharm - Step 4](https://apidocs.io/illustration/python?step=projectFiles&workspaceFolder=MarvelComics-Python&libraryName=marvelcomics.marvelcomics_client&projectName=marvelcomics)
...
![Run Test Project - Step 1](https://apidocs.io/illustration/python?step=runProject&workspaceFolder=MarvelComics-Python&libraryName=marvelcomics.marvelcomics_client&projectName=marvelcomics)
...
client = MarvelcomicsClient(apikey)
```
...
collect['modified_since'] = modified_since

name = 'name'
collect['name'] = name

name_starts_with = 'nameStartsWith'
collect['name_starts_with'] = name_starts_with

offset = 'offset'
collect['offset'] = offset

order_by = 'name'
collect['order_by'] = order_by
...
result = events_client.get_events_collection_by_story_id(collect, optional_query_parameters, )

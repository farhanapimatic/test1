...
### <a name="get_bibcode"></a>![Method: ](https://apidocs.io/img/method.png ".api_pkg.GetBibcode") GetBibcode
...
result,_ = aPI.GetBibcode(bibcode, dbKey, dataType)

...
use HelloWorldLib\Http\HttpCallBack;
...
class HttpCallBackCatcher extends HttpCallBack
{
    /**
     * Http request
     * @var HelloWorldLib\Http\HttpRequest
     */
    private $request;

    /**
     * Http Response
     * @var HelloWorldLib\Http\HttpResponse
     */
    private $response;
     ...
     * @return HelloWorldLib\Http\HttpRequest
     */
     ...
     * @return HelloWorldLib\Http\HttpResponse
     */

 ...
 */
class CharacterDataWrapperModel implements JsonSerializable
{
    /**
     ...
     * @required
     * @var CharacterDataContainerModel $data public property
     */
    public $data;
     ...
     * @param CharacterDataContainerModel $data            Initialization value for $this->data

 ...
 */
class CreatorDataWrapperModel implements JsonSerializable
{
    /**
     ...
     * @required
     * @var CreatorDataContainerModel $data public property
     */
    public $data;
     ...
     * @param CreatorDataContainerModel $data            Initialization value for $this->data

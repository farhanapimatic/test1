 ...
 */
class ComicDataWrapperModel implements JsonSerializable
{
    /**
     ...
     * @required
     * @var ComicDataContainerModel $data public property
     */
    public $data;
     ...
     * @param ComicDataContainerModel $data            Initialization value for $this->data

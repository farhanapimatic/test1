 ...
 */
class SeriesDataWrapperModel implements JsonSerializable
{
    /**
     ...
     * @required
     * @var SeriesDataContainerModel $data public property
     */
    public $data;
     ...
     * @param SeriesDataContainerModel $data            Initialization value for $this->data

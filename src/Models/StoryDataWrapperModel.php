 ...
 */
class StoryDataWrapperModel implements JsonSerializable
{
    /**
     ...
     * @required
     * @var StoryDataContainerModel $data public property
     */
    public $data;
     ...
     * @param StoryDataContainerModel $data            Initialization value for $this->data

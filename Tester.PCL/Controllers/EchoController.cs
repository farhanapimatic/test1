...
namespace Tester.PCL.Controllers
{
    public partial class EchoController: BaseController, IEchoController
    {
        ...
        public dynamic CreateJsonEcho(object input)
        {
            Task<dynamic> t = CreateJsonEchoAsync(input);
        ...
        /// <param name="input">Required parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateJsonEchoAsync(object input)
        {
        ...
        /// <param name="input">Required parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public dynamic CreateFormEcho(object input)
        {
            Task<dynamic> t = CreateFormEchoAsync(input);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="input">Required parameter: Example: </param>
        /// <return>Returns the dynamic response from the API call</return>
        public async Task<dynamic> CreateFormEchoAsync(object input)
        {
            //validating required parameters
            if (null == input)
                throw new ArgumentNullException("input", "The parameter \"input\" is a required parameter and cannot be null.");
        ...
        public Models.EchoResponseModel GetQueryEcho(Dictionary<string, object> queryParameters = null)
        {
            Task<Models.EchoResponseModel> t = GetQueryEchoAsync(queryParameters);
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="queryParameters">Additional optional query parameters are supported by this endpoint</param>
        /// <return>Returns the Models.EchoResponseModel response from the API call</return>
        public async Task<Models.EchoResponseModel> GetQueryEchoAsync(Dictionary<string, object> queryParameters = null)
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();

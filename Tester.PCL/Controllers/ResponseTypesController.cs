...
namespace Tester.PCL.Controllers
{
    public partial class ResponseTypesController: BaseController, IResponseTypesController
    {
        ...
        public List<Models.SuiteCodeEnum> GetIntEnumArray()
        {
            Task<List<Models.SuiteCodeEnum>> t = GetIntEnumArrayAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the List<Models.SuiteCodeEnum> response from the API call</return>
        public async Task<List<Models.SuiteCodeEnum>> GetIntEnumArrayAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            try
            {
                return APIHelper.JsonDeserialize<List<Models.SuiteCodeEnum>>(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        public List<Models.DaysEnum> GetStringEnumArray()
        {
            Task<List<Models.DaysEnum>> t = GetStringEnumArrayAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the List<Models.DaysEnum> response from the API call</return>
        public async Task<List<Models.DaysEnum>> GetStringEnumArrayAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            try
            {
                return APIHelper.JsonDeserialize<List<Models.DaysEnum>>(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        public Models.SuiteCodeEnum? GetIntEnum()
        {
            Task<Models.SuiteCodeEnum?> t = GetIntEnumAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the Models.SuiteCodeEnum? response from the API call</return>
        public async Task<Models.SuiteCodeEnum?> GetIntEnumAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            try
            {
                return (Models.SuiteCodeEnum) int.Parse(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        public List<Models.PersonModel> GetModelArray()
        {
            Task<List<Models.PersonModel>> t = GetModelArrayAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the List<Models.PersonModel> response from the API call</return>
        public async Task<List<Models.PersonModel>> GetModelArrayAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            try
            {
                return APIHelper.JsonDeserialize<List<Models.PersonModel>>(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        public Models.DaysEnum? GetStringEnum()
        {
            Task<Models.DaysEnum?> t = GetStringEnumAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the Models.DaysEnum? response from the API call</return>
        public async Task<Models.DaysEnum?> GetStringEnumAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            try
            {
                return Models.DaysEnumHelper.ParseString(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);
        ...
        public Models.PersonModel GetModel()
        {
            Task<Models.PersonModel> t = GetModelAsync();
            APIHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// </summary>
        /// <return>Returns the Models.PersonModel response from the API call</return>
        public async Task<Models.PersonModel> GetModelAsync()
        {
            //the base uri for api requests
            string _baseUri = Configuration.GetBaseURI();
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.PersonModel>(_response.Body);
            }
            catch (Exception _ex)
            {
                throw new APIException("Failed to parse the response: " + _ex.Message, _context);

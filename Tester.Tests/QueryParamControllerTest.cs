...
namespace Tester.Tests
{
    ...
    public class QueryParamControllerTest : ControllerTestBase
    {
        ...
        public async Task TestIntegerEnumArray() 
        {
            ...
            try
            {
                result = await controller.GetIntegerEnumArrayAsync(suites);
            }
            catch(APIException) {};
        ...
        public async Task TestStringEnumArray() 
        {
            ...
            try
            {
                result = await controller.GetStringEnumArrayAsync(days);
            }
            catch(APIException) {};
        ...
        public async Task TestStringArray() 
        {
            ...
            try
            {
                result = await controller.GetStringArrayAsync(strings);
            }
            catch(APIException) {};
        ...
        public async Task TestNumberArray() 
        {
            ...
            try
            {
                result = await controller.GetNumberArrayAsync(integers);
            }
            catch(APIException) {};
        ...
        public async Task TestUrlParam() 
        {
            ...
            try
            {
                result = await controller.GetUrlParamAsync(url);
            }
            catch(APIException) {};
        ...
        public async Task TestStringParam() 
        {
            ...
            try
            {
                result = await controller.GetStringParamAsync(mstring);
            }
            catch(APIException) {};
        ...
        public async Task TestMultipleParams() 
        {
            ...
            try
            {
                result = await controller.GetMultipleParamsAsync(number, precision, mstring, url);
            }
            catch(APIException) {};
        ...
        public async Task TestSimpleQuery() 
        {
            ...
            try
            {
                result = await controller.GetSimpleQueryAsync(boolean, number, mstring, queryParams);
            }
            catch(APIException) {};
        ...
        public async Task TestRfc3339DateTime() 
        {
            ...
            try
            {
                result = await controller.GetRfc3339DateTimeAsync(datetime);
            }
            catch(APIException) {};
        ...
        public async Task TestRfc3339DateTimeArray() 
        {
            ...
            try
            {
                result = await controller.GetRfc3339DateTimeArrayAsync(datetimes);
            }
            catch(APIException) {};
        ...
        public async Task TestRfc1123DateTimeArray() 
        {
            ...
            try
            {
                result = await controller.GetRfc1123DateTimeArrayAsync(datetimes);
            }
            catch(APIException) {};
        ...
        public async Task TestRfc1123DateTime() 
        {
            ...
            try
            {
                result = await controller.GetRfc1123DateTimeAsync(datetime);
            }
            catch(APIException) {};
        ...
        public async Task TestUnixDateTime() 
        {
            ...
            try
            {
                result = await controller.GetUnixDateTimeAsync(datetime);
            }
            catch(APIException) {};
        ...
        public async Task TestUnixDateTimeArray() 
        {
            ...
            try
            {
                result = await controller.GetUnixDateTimeArrayAsync(datetimes);
            }
            catch(APIException) {};
        ...
        public async Task TestDate() 
        {
            ...
            try
            {
                result = await controller.GetDateAsync(date);
            }
            catch(APIException) {};
        ...
        public async Task TestDateArray() 
        {
            ...
            try
            {
                result = await controller.GetDateArrayAsync(dates);
            }
            catch(APIException) {};
